if(!RouteEngine) {
	...
	RouteEngine.noImage = loadImage("images/none.png", 20, 20);
 ...
 * @param1 {canvas} - An HTML5 canvas element.
 * @class
 */
function Game(element) {
	...
	/**
	 * @function
         * Draws the background and all of the sprites.
	 */
...
/**
  * Background class--holds the information about the background color/image/rendering.
  * @class
  */
function Background(type, value) {
	...
	/**
          * @function
	  * Draws itself onto the given game canvas.
	  * @param {Game} game - The Game to draw onto.
	  */
...
/**
  * A class that holds and handles the playing of a sound file.
...
/**
  * String of characters printed on the Game Canvas with the given style.
  * @param {String} text - The text to be printed.
  * @param {Number} x - The starting x-position of the sprite.
  * @param {Number} y - The starting y-position of the sprite.
  * @class
  */
